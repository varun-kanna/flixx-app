const global = {
	...
	api: {
		apiKey: '499feb17664aeae6c821e544e90dec3f',
...
async function displayPopularShows() {
	const shows = document.querySelector('#popular-shows');
...
async function fetchAPIData(endpoint) {
	// Store key and make requests from a server
	const API_KEY = global.api.apiKey;
	const API_URL = global.api.apiUrl;
	showSpinner();
